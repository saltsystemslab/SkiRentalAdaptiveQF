...
test_results_t run_throughput_test_adaptive(size_t qbits, size_t rbits, uint64_t *insert_set, size_t insert_set_len, uint64_t *query_set, size_t query_set_len, int verbose, char *inserts_outfile, char *queries_outfile) {
...
int main(int argc, char **argv)
{
	...
	// TODO(chesetti): Make the seed a flag.
	...
	ret = run_throughput_test_adaptive(qbits, rbits, insert_set, num_inserts, query_set, num_queries, 1, "unif_i.csv", "unif_q.csv");
	if (ret.exit_code) {
		printf("Test failed\n");
	}
	return 0;
